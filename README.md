...
| Extreme (Sonderfahrten) | ✅/⚠️ 5 %: R² **0.58** (UMAP 0.36, t-SNE 0.35, PaCMAP 0.30; PCA 0.67, Isomap 0.77); 10 %: 0.74 (0.24 / 0.26 / 0.22) – aber 2 %: 0.51 (0.62 / 0.66 / 0.58) |
...
- **Sonderfahrten: nur eine Teilantwort.** Bei 5–10 % bleibt das Netz deutlich vor t-SNE/UMAP/PaCMAP, bei 2 % nicht, und es bleibt unter PCA und Isomap; mit Extremen rekonstruiert es teils schlechter als die PCA-Untergrenze (5 %: 0.116 gegen 0.062).
