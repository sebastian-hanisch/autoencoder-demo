...
PRESET_EXPECTED_BANDS = {
    ...
    "Sonderfahrten: Extreme bleiben erhalten": {"verdict": "extremes_kept", "r2": (0.3, 1.0), "r2_umap": (-0.3, 0.6), "r2_tsne": (-0.3, 0.6), "r2_pacmap": (-0.3, 0.6), "r2_pca": (0.55, 0.9), "r2_iso": (0.6, 0.9)},
